...
basedir = '/global/cfs/projectdirs/m3761/FLASH/FFI_3D/NSM_3/t5/'
plotdir = '/global/cfs/projectdirs/m3761/FLASH/FFI_3D/NSM_3/'
#t1
...
basedir_special = '/global/cfs/projectdirs/m3761/FLASH/FFI_3D/NSM_3/t2/'

filename_bang   = basedir_special + 'res_a/' + "reduced_data_fft_power.h5"
filename_bang_avg   = basedir + simres[2] + "reduced_data.h5"
k2,N2 = plotdata(filename_bang,filename_bang_avg,tplot)
ax.semilogy(k2, N2, 'b-', label = r'$N_{{gp}}/L={}/{:.3f}\,{{\rm cm}}$'.format(n_grid/4,box_length/4.0))

#Vertical line from LSA for fastet growing mode
#ax.axvline(5.64, color='g', label=None)

ax.legend(loc='upper right', fontsize=14, frameon=False)
plt.savefig(plotdir + "Nex_FFT_3res_special.pdf", bbox_inches="tight")
