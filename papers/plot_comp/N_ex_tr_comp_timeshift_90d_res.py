...
filename_emu_3f = "/global/project/projectdirs/m3761/Evan/90Degree_3D_3F_reduced_data.h5"
filename_emu_3f_32d = "/global/project/projectdirs/m3761/Evan/90Degree_3D_3F_32d_reduced_data.h5"
...
#tmax = t[np.argmax(N)]
#ax.semilogy(t-tmax, N, 'k-', label=r'${\rm emu\,\,(2f)}$')
...
###
tmax = t[np.argmax(N)]
ax.semilogy(t-tmax, N, 'k--', label=r'${\rm emu\,\,(3f)}$')

t,N = plotdata(filename_emu_3f_32d,0,1)
tmax = t[np.argmax(N)]
ax.semilogy(t-tmax, N, 'c--', label=r'${\rm emu\,\,(3f\,32d)}$')

t,N = plotdata(filename_bang,0,1)
tmax = t[np.argmax(N)]
ax.semilogy(t-tmax, N, 'r--', label=r'${\rm FLASH\,\,(2f)}$')
ax.set_xlabel(r"$t-t_{\rm sat}\,(10^{-9}\,{\rm s})$")
ax.set_ylabel(r"$\langle |N_{ex}|/{\rm Tr}[N]\rangle$")
#ax.legend(loc='upper right')
plt.savefig("N_ex_tr_comp_timeshift_90d_res.pdf", bbox_inches="tight")
