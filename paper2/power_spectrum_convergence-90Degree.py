...
dirlist = ["convergence/90Degree_3D_32d", "90Degree_3D"]
...
norm = mpl.colors.Normalize(vmin=0, vmax=tmax*1e9)
...
plt.savefig("power_spectrum_convergence_90Degree.pdf", bbox_inches='tight')
