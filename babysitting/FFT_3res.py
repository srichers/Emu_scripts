...
basedir = '/global/cfs/projectdirs/m3761/FLASH/FFI_3D/NSM_2/t3/'
...
ax.semilogy(k2, N2, 'r-', alpha=0.25,  label=r'${\rm {\tt FLASH}\,\,(2f)}$')
...
ax.semilogy(k1, N1, 'r-', alpha=0.5, label=r'${\rm {\tt FLASH}\,\,(2f)}$')
...
ax.semilogy(k0, N0, 'r-', label=r'${\rm {\tt FLASH}\,\,(2f)}$')

#Vertical line from LSA for fastet growing mode
#ax.axvline(5.64, color='g', label=None)

#ax.legend(loc='upper right', frameon=False)
plt.savefig("Nex_FFT_3res.pdf", bbox_inches="tight")
