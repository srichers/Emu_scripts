...
if nu_type == 1:
    axes[0].set_ylabel(r'$\langle \overline{N}_{ee}\rangle/\overline{N}_{ee}(0)$')
    axes[1].set_ylabel(r'$\langle|\overline{N}_{ex}|\rangle/\overline{N}_{ee}(0)$')
else:
    axes[0].set_ylabel(r'$\langle N_{ee}\rangle/N_{ee}(0)$')
    axes[1].set_ylabel(r'$\langle|N_{ex}|\rangle/N_{ee}(0)$')
...
print('tmax = ', tmax)
axes[0].plot(t-tmax, Nee/N0, 'r-', label='2f')
axes[1].semilogy(t-tmax, Nex/N0, 'r-', label='2f')
...
namestr = "Nee_Nex_1res_norm0_" + nu_type_str + ".pdf"
