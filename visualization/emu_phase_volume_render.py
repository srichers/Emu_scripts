...
@derived_field(name="N02_Phase", units="dimensionless", display_name=r'\phi_{e\tau}\,\,(degrees)', sampling_type="cell",force_override=True)
def _N02_Phase(field, data):
    return np.arctan2(data["N02_Im"],data["N02_Re"])*(180/np.pi)
@derived_field(name="N12_Phase", units="dimensionless", display_name=r'\phi_{\mu\tau}\,\,(degrees)', sampling_type="cell",force_override=True)
